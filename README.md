...
Executing an aggregation pipeline which performs a _$set/$addFields/$project_ operation using the expression generated by the _graphDescend()_ function will output documents similar to the one shown below.
